...
class TestLinkHelper(object):
    ...
    DEFAULT_SERVER_URL  = 'http://192.168.50.193/lib/api/xmlrpc/v1/xmlrpc.php'
    DEFAULT_DEVKEY      = '7b6bb5bf0c0544699a5513007dcddff7'
    ...
    if '192.168.60.' in ip:
        ...
        DEFAULT_SERVER_URL  = 'http://10.1.145.70/lib/api/xmlrpc/v1/xmlrpc.php'
