...
global dummyHeader
set dummyHeader(BGP_routeConvergence) 1;
...
global BGP;
set BGP(routeConvergence) "Route Convergence";

global doNotSupportLearnMacOnly;
set doNotSupportLearnMacOnly(BGP_routeConvergence) 1;

global gTestCommand;
set gTestCommand(routeConvergence) bgpSuite;

global supportMaskWidth;
set supportMaskWidth(BGP_routeConvergence) 1;

global doNotSupportLearn;
set doNotSupportLearn(BGP_routeConvergence) 1;

global protocolsSupportedByTest;
set protocolsSupportedByTest(BGP_routeConvergence) {ip};

global supportResultsCsv
global supportAggResultsCsv
global supportIterationCsv
set supportResultsCsv(BGP_routeConvergence) true
set supportAggResultsCsv(BGP_routeConvergence) false
set supportIterationCsv(BGP_routeConvergence) false
...
proc scriptmateCommands::init_zz_bgpSuite {} \
{
    ...
    defineTest registerTest      bgpSuite {routeCapacity peerCapacity routeConvergence}
}
...
DummyHeaderLogFileNameSet "bgpRouteConvergence.log";
