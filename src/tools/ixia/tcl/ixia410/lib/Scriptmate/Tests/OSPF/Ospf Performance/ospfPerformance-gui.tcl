...
namespace eval ospfPerformanceGUI {};

#####################################################################
# ospfPerformanceGUI::runParamsContent
# 
# DESCRIPTION:
...
#  
###
set ospfPerformanceGUI::runParamsContent {
    { FRAMES {
            { FRAME {
                { NAME  left }
                { LABEL "" }
    ...
    { FRAME {
        ...
        { FRAME {
            { NAME  ospfParams }
            { LABEL "OSPF Parameters" }
            { FRAMES {
            { FRAME {
                { NAME  invisibleOspfParams }
                { LABEL "" }
                { ELEMENTS {
                      { ELEMENT {
                                { NAME              ospfAreaID }
...
#####################################################################
# ospfPerformanceGUI::trafficContent
# 
# DESCRIPTION:
# This content table contains a list of FRAMES and/or ELEMENTS which 
...
#  
###
set ospfPerformanceGUI::trafficContent {
    { FRAMES {
	{ FRAME {
	    { NAME              x }
	    { GEOMGR            place }
