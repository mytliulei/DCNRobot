...
namespace eval routeCapacityGUI {}

#####################################################################
# routeCapacityGUI::runParamsContent
# 
# DESCRIPTION:
...
#  
###
set routeCapacityGUI::runParamsContent {
    { FRAMES {
	{ FRAME {
	    { NAME  left }
	    { LABEL "" }
...
#####################################################################
# routeCapacityGUI::trafficContent
# 
# DESCRIPTION:
# This content table contains a list of FRAMES and/or ELEMENTS which 
...
#  
###
set routeCapacityGUI::trafficContent {
     { FRAMES {
	{ FRAME {
	    { NAME              x }
	    { GEOMGR            place }
