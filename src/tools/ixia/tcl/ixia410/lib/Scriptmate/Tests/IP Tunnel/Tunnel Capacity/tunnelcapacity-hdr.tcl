...
global dummyHeader
set dummyHeader(Tunnel_tunnelCapacity) 1;
...
global Tunnel;
set Tunnel(tunnelCapacity) "Tunnel Capacity";

global automap;
set automap(Tunnel_tunnelCapacity) {Automatic};


set directions(Tunnel_tunnelCapacity) {Unidirectional};

global learnFrequencyValidValues;
set learnFrequencyValidValues(Tunnel_tunnelCapacity) {oncePerTest oncePerFramesize onTrial never};

global gTestCommand;
set gTestCommand(tunnelCapacity) tunnel;

global protocolsSupportedByTest;
set protocolsSupportedByTest(Tunnel_tunnelCapacity) {ip ipv6};

global supportResultsCsv
global supportAggResultsCsv
global supportIterationCsv
set supportResultsCsv(Tunnel_tunnelCapacity) true
set supportAggResultsCsv(Tunnel_tunnelCapacity) true
set supportIterationCsv(Tunnel_tunnelCapacity) true
...
DummyHeaderLogFileNameSet "ipv6TunnelCapacity.log";
