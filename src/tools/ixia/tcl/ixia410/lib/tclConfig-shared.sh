...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-Le:/Tcl8.4/lib -ltcl84'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Ie:/Tcl8.4/include'
...
TCL_PACKAGE_PATH='e:/Tcl8.4/lib e:/Tcl8.4/lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Le:/Tcl8.4/lib -ltclstub84'
...
TCL_STUB_LIB_PATH='e:/Tcl8.4/lib/tclstub84.lib'
