...
#
# ActiveState ActiveTcl 8.4.19.2.291226 Win32/x86, Mon Sep 21 11:40:57 PM Pacific Standard Time 2009
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1253601657}
	buildtime,fmt {Mon Sep 21 11:40:57 PM Pacific Standard Time 2009}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.4.19.2.291226 Win32/x86 @ Mon Sep 21 11:40:57 PM Pacific Standard Time 2009 / normal}
    }
}

package provide {ActiveTcl} {8.4.19.2.291226}
